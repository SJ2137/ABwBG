...
```{r}
fq_file <- "C:/Users/everything/studia/magisterka/semestr2/R/QC/SRR31303920.fastq.gz" 
...
```{r}
report(qa_results, dest = "C:/Users/48721/Desktop/everything/studia/magisterka/semestr2/R/QC")
```
...
```{r}
rqc_results <- rqc(path = "C:/Users/48721/Desktop/everything/studia/magisterka/semestr2/R/QC", pattern = "SRR31303920.fastq.gz", sample = TRUE)
